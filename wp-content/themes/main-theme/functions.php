...
function theme_files(){
    ...
    wp_enqueue_script('fontawsome-js', get_theme_file_uri('/js/fontawesome/js/all.js'), NULL, '1.0', true);
    wp_enqueue_script('fontawsome-css', get_theme_file_uri('/js/fontawesome/css/all.css'));
